...
public class TimerService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            nm.createNotificationChannel(new NotificationChannel("com.google.android.apps.location.gps.gnsslogger", "TimerService", NotificationManager.IMPORTANCE_DEFAULT));
        } else {
